...
def train():
    ...
    print("=================================================")
    print("🚀 开始分离式双脑训练 (IPPO + CTDE 宏观视野)")
    print("=================================================")
    ...
    for episode in range(1, total_episodes + 1):
        ...
        ep_cost = ep_transport + ep_penalty
        ...
        if episode % 10 == 0:
            ...
            print(f"[Ep {episode:04d}] 奖赏: {ep_reward:7.1f} | 覆盖率: {avg_cov*100:5.2f}% | 均成本: {avg_cost:7.0f} | 拒单: {ep_penalty:7.0f} | 预测MSE: {real_mse:.1f}")
